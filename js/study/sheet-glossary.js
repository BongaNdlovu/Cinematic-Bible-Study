(function () {
  ...
  window.SHEET_GLOSSARY = [
    ...
    entry("preterism", "Preterism", ["preterist"], "word",
      ...
      "In the form this sitting names, Jesuit Luis de Alcázar (1614) parked Daniel under Antiochus IV in the 160s B.C. and Revelation at Jerusalem’s fall in A.D. 70. The medieval and modern church then fall out of the prophecy. A weaker cousin is the older pagan charge of Porphyry: Daniel was written after the events.",
    ...
    entry("dispensationalism", "Dispensationalism", ["dispensational"], "word",
      ...
      "Edward Irving and John Nelson Darby popularized it in the 1830s; the 1909 Scofield Reference Bible spread it in English pews. It is not in Daniel’s wording. Gabriel never says “insert two thousand years here.”",
    ...
    entry("apocalyptic", "apocalyptic", ["Apocalyptic"], "word",
      ...
      "Daniel 7–8 is apocalyptic: a lion is not a zoo animal. Time inside that same symbolic vision is not automatically a wall-clock day. Narrative chapters (1, 3–6) are different: a “day” or “time” there can be an ordinary human day or year, as in Nebuchadnezzar’s seven times.",
    ...
    entry("colossus", "colossus", ["Colossus", "metallic colossus"], "word",
      ...
      "Only the gold head is named (Babylon, 2:38). Later metals are identified by succession and by later chapters that name Medo-Persia and Greece. The stone is not a repair kit. It strikes the feet and fills the earth.",
    ...
    entry("nitsdaq", "nitsdaq", ["cleansed", "put right"], "word",
      "The verb in Daniel 8:14: the sanctuary is justified, vindicated, put right — not mopped.",
    ...
    entry("most-holy", "Most Holy Place", ["Most Holy", "Holy of Holies"], "word",
      ...
      "Leviticus 16. This study reads Daniel 8:14’s putting-right as that day’s heavenly counterpart — judgment and vindication — not a janitor’s mop in Jerusalem.",
    ...
    entry("trent", "Council of Trent", ["Trent"], "word",
      ...
      "Twenty-five sessions. This sitting names it as the moment the historicist charge against a church-state Antichrist was felt to be pastorally dangerous, and new schools of reading were funded to break the chain.",
    ...
    entry("jesuit", "Jesuit", ["Jesuits", "Society of Jesus"], "word",
      ...
      "Luis de Alcázar and Francisco Ribera were Spanish Jesuits whose commentaries became the templates for preterism and futurism. This study names their methods. It does not ask you to treat every Jesuit as a cartoon villain.",
      IMG + "glossary-jesuit.png"),
    entry("zeroim", "zeroim", [], "word",
      "Hebrew for vegetables, grains, and seeds — the food of Daniel’s ten-day test.",
      "Daniel 1:12. Echoes Genesis 1:29. The point is not a modern diet fad. The royal table had been offered to Marduk and mixed unclean meat (Leviticus 11). Daniel drew the line at worship, not at Akkadian class.",
    ...
    entry("cubit", "cubit", ["cubits"], "word",
      ...
      "The Dura image is 60 cubits by 6 cubits (Daniel 3:1). Babylon counted in sixties. This sitting notes the all-gold design as a public denial of the multi-metal dream, not as a trivia number.",
    ...
    entry("sola-fide", "sola fide", [], "word",
      ...
      "Paired with sola scriptura as the Reformation’s other engine. The prophetic charge (the little horn as a church-state) rode with that gospel protest; it was not a side hobby.",
    ...
    entry("mene", "MENE, TEKEL, UPHARSIN", ["MENE", "TEKEL", "UPHARSIN", "PERES"], "word",
      ...
      "Daniel 5. God has numbered Belshazzar’s kingdom and finished it; the king is too light on the scale; the realm is split to Medes and Persians. It is an audit, not a ghost story.",
    ...
    entry("exile", "exile", ["Babylonian exile", "Babylonian captivity"], "word",
      ...
      "Exile was not voluntary tourism or a mere accident of war. Daniel 1:2 declares that God handed Jehoiakim over. Daniel begins in the first levy (605 B.C.), Ezekiel in the second (597 B.C.), and the city and temple were burned in the third (586 B.C., 2 Kings 25).",
    ...
    entry("typology", "typology", ["type", "antitype", "antitypical", "type-pattern", "prophetic pattern"], "word",
      ...
      "Dura is the type of forced worship; Revelation 13 is its global antitype. The earthly Day of Atonement is the type; Daniel 8:14 is the antitype in heaven. A type is not a cute metaphor you invent. It is a pattern Scripture itself repeats.",
    ...
    entry("darius-mede", "Darius the Mede", [], "person",
      ...
      "Greek histories name Cyrus as conqueror and do not list this Median Darius. Honest options: a governor (Ugbaru/Gubaru) with a throne-name; a short Median colleague of Cyrus; or Cyrus under a Median title. The chapter’s load-bearing test is the unchangeable law against prayer, not the modern ID card.",
    ...
    entry("gabriel", "Gabriel", [], "person",
      ...
      "He interprets the ram and goat, then returns while Daniel is praying to cut seventy weeks from the unexplained vision. In Luke 1 he announces John and Jesus. He is a messenger, not a mascot.",
    ...
    entry("michael", "Michael", [], "person",
      ...
      "He helps against the prince of Persia (10:13, 21). Jude 9 and Revelation 12 show him in conflict with the dragon. “Stands up” in 12:1 is read as the high priest finishing intercession. You may test that identification; do not empty the sanctuary picture.",
    ...
    entry("calvin", "John Calvin", ["Calvin"], "person",
      ...
      "He kept the four kingdoms as real empires and refused to treat the book as a finished Maccabean pamphlet. Cited on sheet 0 as part of the Protestant consensus, not as an infallible pope of Geneva.",
    ...
    entry("newton-isaac", "Isaac Newton", ["Newton", "Sir Isaac Newton"], "person",
      ...
      "He called Daniel “most distinct in order of time.” This study quotes that line because it states Historicism in one sentence: the book is a dated sequence, not a riddle parked in the past or the far future.",
    ...
    entry("alcazar", "Luis de Alcázar", ["Alcázar", "Alcazar"], "person",
      ...
      "Vestigatio Arcani Sensus in Apocalypsi. He exhausted Daniel under Antiochus and Revelation in A.D. 70 so the living church would not sit under Protestant historicist scrutiny.",
    ...
    entry("irving", "Edward Irving", ["Irving"], "person",
      ...
      "A channel, with Darby, for Ribera’s severed week. Named so sheet 0’s “19th-century Great Shift” has faces, not a fog.",
    ...
    entry("jerusalem", "Jerusalem", ["Glorious Land", "Zion"], "place",
      ...
      "First vessels leave in 605; city and Temple fall in 586; return decrees under Persia. In Daniel 8 “the Glorious Land” is Judah. The sanctuary put right in 8:14 is not this hill being mopped in 164 B.C.",
    ...
    entry("pella", "Pella", [], "place",
      ...
      "Used on this desk’s map as a Greece node. The prophecy’s load-bearing name is Greece (8:21), not the tourist label.",
