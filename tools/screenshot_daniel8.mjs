...
try {
  ...
  const shots = [
    { id: 'ram', title: 'Ram of Medo-Persia', out: 'gallery_ram.png' },
    { id: 'goat', title: 'Charging Goat', out: 'gallery_goat.png' },
    { id: 'goat_broken', title: 'Broken Horn', out: 'gallery_goat_broken.png' },
    { id: 'goat_horn', title: 'Little Horn of the Goat', out: 'gallery_goat_horn.png' },
  ];
  ...
  await client.shot('index_daniel8.png');
