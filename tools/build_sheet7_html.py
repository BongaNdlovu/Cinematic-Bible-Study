"""Generate Sheet 7 article HTML — The Churning Sea & The Little Horn (Daniel 7)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent / "sheet7_generated.html"
...
<div class="framework-card">
  ...
  <p>The investigative judgment is good news for the believer. Christ does not enter the court to condemn His people, but to advocate for them, blot out their sins, and award them the everlasting kingdom. With Christ as our Advocate, we face the opened books with peace, joy, and unfailing confidence.</p>
</div>
