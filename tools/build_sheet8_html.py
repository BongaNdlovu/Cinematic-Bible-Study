"""Generate Sheet 8 article HTML — The Ram, The Goat, & 2,300 Days (Daniel 8)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent / "sheet8_generated.html"
...
<p>In Seventh-day Adventist historicist hermeneutics, this little horn represents <strong>Rome in both of its successive historical phases: Pagan and Papal</strong>. The <em>SDA Bible Commentary</em> articulates this established consensus:</p>
...
<div class="historical-note">
  ...
  <ul>
    ...
    <li><strong>The Biblical Resolution:</strong> Prayerful restudy of the Bible (by Hiram Edson, O. R. L. Crosier, and others) revealed that the earth is never called the sanctuary in Scripture. The sanctuary of Daniel 8:14 is the <strong>heavenly sanctuary</strong> (Hebrews 8:1–2; 9:23–24). On October 22, 1844, Jesus Christ entered the Most Holy Place of the heavenly temple to inaugurate the final phase of His high-priestly ministry: the investigative judgment (Daniel 7:9–14) and the cleansing of the heavenly sanctuary prior to His return.</li>
  </ul>
