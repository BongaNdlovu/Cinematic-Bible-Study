...
fs.mkdirSync(path.join('qa', 'reports'), { recursive: true });
...
try {
  ...
  const beasts = [
    { id: 'lion', title: 'Winged Lion', out: 'qa/proofs/gallery_lion.png', thumb: 'assets/thumbs/lion.jpg' },
    { id: 'bear', title: 'Bear', out: 'qa/proofs/gallery_bear.png', thumb: 'assets/thumbs/bear.jpg' },
    { id: 'leopard', title: 'Leopard', out: 'qa/proofs/gallery_leopard.png', thumb: 'assets/thumbs/leopard.jpg' },
    { id: 'beast', title: 'Dreadful Beast', out: 'qa/proofs/gallery_beast.png', thumb: 'assets/thumbs/beast.jpg' },
  ];
  ...
  client.close();
  fs.writeFileSync(path.join('qa', 'reports', 'beast_gallery_report.json'), JSON.stringify(reports, null, 2));
  console.log('DONE');
} finally {
